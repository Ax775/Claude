...
const STRINGS = {
  nl: {
    ...
    'settings.feedback.note':    'Mis je iets, of werkt iets niet lekker? We horen het graag — jouw feedback vormt de app. Er opent een e-mail; je gegevens blijven gewoon op je toestel.',
    'settings.feedback.button':  'Stuur feedback',
    'settings.feedback.subject': 'Feedback over Paced',
    'settings.feedback.body':    'Hoi! Dit wil ik graag kwijt over Paced:\n\n\n\n— context (mag je weghalen): {platform}, taal {locale}',
  ...
  en: {
    ...
    'settings.feedback':         'Feedback',
    'settings.feedback.note':    'Missing something, or does something feel off? We\'d love to hear it — your feedback shapes the app. This opens an email; your data stays on your device.',
    'settings.feedback.button':  'Send feedback',
    'settings.feedback.subject': 'Feedback about Paced',
    'settings.feedback.body':    'Hi! Here\'s what I\'d like to share about Paced:\n\n\n\n— context (feel free to remove): {platform}, language {locale}',
    'settings.legal':            'Privacy & disclaimer',
